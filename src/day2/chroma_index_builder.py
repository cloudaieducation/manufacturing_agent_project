# -*- coding: utf-8 -*-
"""
2일차 RAG 실습 - Chroma Vector DB 저장기

이 파일은 outputs/day2/chunk_preview.json 파일을 읽고,
Ollama의 nomic-embed-text:latest 모델로 embedding을 생성한 뒤
Chroma Vector DB에 저장합니다.
