# -*- coding: utf-8 -*-
"""
Day5 mcp_server02 - Tool Selector (LLM 기반 Tool Selection)
...
# contracts: 프롬프트에 넣을 허용 Tool 목록/계약과, fallback 이 만들 Tool 의 기준.
#            tool_selector 는 이 범위 '밖'의 Tool 을 절대 생성하지 않는다.
from day5.mcp_server02.contracts import ALLOWED_TOOLS, TOOL_CONTRACTS
