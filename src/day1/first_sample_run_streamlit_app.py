"""
제조 기업 재직자 대상 AI Agent Architecture 1일차 Streamlit 실습 화면입니다.
...
def run_agent_once(project_root):
    ...
    # 3. 필수 파일이 없으면 수강생이 어떤 파일이 빠졌는지 바로 알 수 있게 명확한 메시지로 알려줍니다.
    required_files = [
        query_path,
        log_path,
        manual_path,
    ...
    # 9. 관련 로그 일부를 LLM이 그대로 읽을 수 있는 JSON 문자열로 바꿉니다.
