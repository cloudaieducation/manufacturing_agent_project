"""
제조 기업 재직자 대상 AI Agent Architecture 1일차 7교시 단순 Agent v0 실습 파일입니다.

이 파일은  위에서 아래로 실행 흐름을 이해할 수 있도록
...
def run_day1_agent_v0():
    ...
    def search_manual_node(state):
        ...
        # 여기서는  흐름을 이해하기 쉽도록 단순 문자열 검색만 사용합니다.
    ...
    # 8. LangGraph를 구성합니다.
    # dict 기반 State를 사용해서 State 구조를 코드에서 직접 확인할 수 있게 했습니다.
