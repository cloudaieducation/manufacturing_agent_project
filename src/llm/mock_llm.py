...
- 외부 API를 호출하지 않습니다.
- 실제 AI 모델이 아닙니다.
- 실제 제조 기업의 사내 데이터, 실제 설비명, 실제 라인명,
...
> 실제 제조 기업의 사내 데이터, 실제 설비 기준, 실제 공정 조건, 실제 조치 절차와 무관합니다.  
...
> 실제 제조 데이터, 실제 설비 기준, 실제 공정 조건과 무관합니다.
...
> 이 응답은 DisplayEdu Fab 교육용 Mock LLM 응답입니다.  
> 실제 제조 기업의 업무 요청이나 실제 내부 시스템 응답이 아닙니다.
