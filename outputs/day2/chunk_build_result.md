...
|---|---:|
| alarm_manual.md | 78 |
| day4_text_to_sql_safety_checklist.md | 60 |
| day5_tool_plan_rag_remediation_plan.md | 14 |
...
- equipment_id: 
- keywords: 
- text 미리보기: 이 문서는 제조 기업 재직자 대상 AI Agent Architecture 강의에서 사용할 **교육용 가상 알람 매뉴얼**입니다.
