...
- Output tag: fallback_rule_holdout_full
...
| HOLDOUT-ACTION-003 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | - | NEEDS_REVIEW | yes | llm | schema_error |
