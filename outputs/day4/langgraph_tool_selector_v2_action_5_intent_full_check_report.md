...
- Output tag: action_5_intent_full_check
...
- Action policy rules: 22
- Argument normalization rules: 23
...
| TC-ACTION-004 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | PASS | no | llm | - |
