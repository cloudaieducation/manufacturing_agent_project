...
| TC-ACTION-002 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | search_manual, get_quality_metrics, get_recent_alarm_events, get_process_status | NEEDS_REVIEW | yes | llm | missing_argument |
...
| TC-ACTION-004 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | get_recent_alarm_events, get_process_status, get_quality_metrics, get_quality_metrics, get_quality_metrics, search_manual | NEEDS_REVIEW | yes | llm | missing_argument |
| TC-ACTION-007 | get_equipment_status, get_recent_alarm_events, get_process_status, get_maintenance_history, search_manual | get_recent_alarm_events, search_manual | NEEDS_REVIEW | yes | llm | missing_tool |
...
- TC-ACTION-002: step 2: 'get_quality_metrics'은 metric_name, equipment_id, line_id 중 하나 이상이 필요합니다.
