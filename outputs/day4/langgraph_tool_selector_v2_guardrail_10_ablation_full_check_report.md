...
- Output tag: guardrail_10_ablation_full_check
...
| TC-017 | - | - | PASS | no | llm | - |
| TC-018 | - | - | PASS | no | llm | - |
| TC-ACTION-008 | get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | search_manual, get_recent_alarm_events, get_maintenance_history, get_process_status, get_quality_metrics | PASS | yes | llm | - |
| TC-ACTION-009 | - | - | PASS | yes | llm | - |
| TC-ACTION-010 | - | - | PASS | no | llm | - |
| TC-ACTION-011 | - | - | PASS | no | llm | - |
| TC-ACTION-012 | - | - | PASS | no | llm | - |
| TC-ACTION-013 | - | - | PASS | yes | llm | - |
