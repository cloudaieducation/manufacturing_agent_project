...
- Output tag: fallback_strict_guardrail_full
...
- Repair success: 1
- Needs review: 1
- Normalization applied: 1/10
- Action policy rules: 0
- Argument normalization rules: 1
...
| TC-017 | - | - | PASS | no | llm | - |
| TC-018 | - | - | PASS | no | llm | - |
| TC-ACTION-008 | get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_recent_alarm_events, search_manual, get_equipment_status, get_maintenance_history, get_process_status, get_quality_metrics | NEEDS_REVIEW | yes | llm | extra_tool |
| TC-ACTION-009 | - | - | PASS | yes | llm | - |
...
- TC-ACTION-008: 기대하지 않은 Tool 'get_equipment_status'이(가) plan에 있습니다.
...
| TC-017 | False | - |
| TC-018 | False | - |
| TC-ACTION-008 | True | ARG-get_process_status-anyof-process_name |
| TC-ACTION-009 | False | - |
| TC-ACTION-010 | False | - |
| TC-ACTION-011 | False | - |
| TC-ACTION-012 | False | - |
