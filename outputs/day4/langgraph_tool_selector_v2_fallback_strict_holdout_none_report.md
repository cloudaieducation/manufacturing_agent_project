...
- Output tag: fallback_strict_holdout_none
...
|---|---|---|---|---|---|---|
| HOLDOUT-ACTION-001 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | - | NEEDS_REVIEW | yes | llm | json_parse_error |
| HOLDOUT-ACTION-002 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | - | NEEDS_REVIEW | yes | llm | json_parse_error |
| HOLDOUT-ACTION-003 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | - | NEEDS_REVIEW | yes | llm | json_parse_error |
| HOLDOUT-ACTION-004 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | - | NEEDS_REVIEW | yes | llm | json_parse_error |
| HOLDOUT-ACTION-005 | get_equipment_status, get_recent_alarm_events, get_process_status, get_maintenance_history, search_manual | get_equipment_status, get_recent_alarm_events, get_maintenance_history, get_equipment_overview, search_manual | NEEDS_REVIEW | yes | - | extra_tool, missing_tool |
...
- HOLDOUT-ACTION-005: 기대하지 않은 Tool 'get_equipment_overview'이(가) plan에 있습니다.
