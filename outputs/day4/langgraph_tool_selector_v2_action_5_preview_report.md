...
|---|---|---|---|---|---|---|
| TC-ACTION-001 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | search_manual, get_process_status | NEEDS_REVIEW | yes | fallback | missing_argument, missing_tool |
...
| TC-ACTION-003 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_recent_alarm_events, get_equipment_status, get_maintenance_history, get_quality_metrics, search_manual | NEEDS_REVIEW | yes | fallback | missing_tool, weak_reason |

## 3. Representative Failures

### Missing Tool

- TC-ACTION-001: 기대 Tool 'get_equipment_status'이(가) plan에 없습니다.
...
- TC-ACTION-001: step 2: 'get_process_status'은 process_name, line_id 중 하나 이상이 필요합니다.
