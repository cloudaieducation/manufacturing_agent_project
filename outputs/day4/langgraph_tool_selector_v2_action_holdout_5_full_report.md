...
- Output tag: action_holdout_5_full
...
- Argument normalization rules: 9
...
|---|---|---|---|---|---|---|
| HOLDOUT-ACTION-001 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_recent_alarm_events, search_manual, get_maintenance_history, get_quality_metrics, get_process_status | NEEDS_REVIEW | yes | fallback | missing_tool |
...
| HOLDOUT-ACTION-003 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_equipment_status, get_recent_alarm_events, get_maintenance_history, get_quality_metrics, search_manual | NEEDS_REVIEW | yes | fallback | missing_tool |
| HOLDOUT-ACTION-004 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | get_recent_alarm_events, search_manual, get_quality_metrics, get_process_status | PASS | yes | fallback | - |
| HOLDOUT-ACTION-005 | get_equipment_status, get_recent_alarm_events, get_process_status, get_maintenance_history, search_manual | get_equipment_status, get_recent_alarm_events, get_maintenance_history, search_manual | NEEDS_REVIEW | yes | fallback | missing_tool |
