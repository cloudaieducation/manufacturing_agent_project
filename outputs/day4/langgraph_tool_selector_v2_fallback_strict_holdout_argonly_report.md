...
- Output tag: fallback_strict_holdout_argonly
...
|---|---|---|---|---|---|---|
| HOLDOUT-ACTION-001 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | PASS | yes | llm | - |
...
| HOLDOUT-ACTION-003 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | - | NEEDS_REVIEW | yes | llm | empty_plan_error, missing_tool |
| HOLDOUT-ACTION-004 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | - | NEEDS_REVIEW | yes | - | empty_plan_error, missing_tool |
| HOLDOUT-ACTION-005 | get_equipment_status, get_recent_alarm_events, get_process_status, get_maintenance_history, search_manual | - | NEEDS_REVIEW | yes | llm | empty_plan_error, missing_tool |
...
- HOLDOUT-ACTION-004: 기대 Tool 'get_process_status'이(가) plan에 없습니다.
...
| HOLDOUT-ACTION-002 | True | ARG-get_recent_alarm_events-equipment_id |
