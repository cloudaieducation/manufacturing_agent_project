...
- Output tag: report_template_holdout_argonly
...
| HOLDOUT-ACTION-002 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | get_recent_alarm_events, search_manual, get_quality_metrics, get_process_status | PASS | yes | fallback | - |
| HOLDOUT-ACTION-003 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_recent_alarm_events, search_manual, get_maintenance_history, get_quality_metrics, get_process_status | NEEDS_REVIEW | yes | fallback | missing_tool |
...
- HOLDOUT-ACTION-003: 기대 Tool 'get_equipment_status'이(가) plan에 없습니다.
