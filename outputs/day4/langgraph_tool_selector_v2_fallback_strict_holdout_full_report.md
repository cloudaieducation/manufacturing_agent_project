...
- Output tag: fallback_strict_holdout_full
...
- Argument normalization rules: 15
...
|---|---|---|---|---|---|---|
| HOLDOUT-ACTION-001 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | PASS | no | - | - |
| HOLDOUT-ACTION-002 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | get_recent_alarm_events, get_process_status, search_manual, get_quality_metrics | PASS | no | llm | - |
| HOLDOUT-ACTION-003 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_recent_alarm_events, get_equipment_status, get_quality_metrics, get_maintenance_history, search_manual, get_process_status | PASS | yes | llm | - |
| HOLDOUT-ACTION-004 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | PASS | no | - | - |
...
|---|---|---|
| HOLDOUT-ACTION-001 | True | ARG-get_equipment_status-equipment_id, ARG-get_maintenance_history-equipment_id, ARG-get_process_status-anyof-process_name, ARG-get_quality_metrics-anyof-equipment_id, ARG-get_recent_alarm_events-equipment_id, ARG-search_manual-query, POLICY-root_cause_ranking-get_equipment_status, POLICY-root_cause_ranking-get_maintenance_history, POLICY-root_cause_ranking-get_process_status, POLICY-root_cause_ranking-get_quality_metrics, POLICY-root_cause_ranking-get_recent_alarm_events, POLICY-root_cause_ranking-search_manual |
| HOLDOUT-ACTION-002 | True | ARG-get_quality_metrics-anyof-equipment_id, ARG-get_recent_alarm_events-equipment_id, POLICY-checklist_generation-get_quality_metrics |
| HOLDOUT-ACTION-003 | True | ARG-get_process_status-anyof-process_name, POLICY-team_routing-get_process_status |
| HOLDOUT-ACTION-004 | True | ARG-get_process_status-anyof-process_name, ARG-get_quality_metrics-anyof-equipment_id, ARG-get_recent_alarm_events-equipment_id, ARG-search_manual-query, POLICY-monitoring_rule_generation-get_process_status, POLICY-monitoring_rule_generation-get_quality_metrics, POLICY-monitoring_rule_generation-get_recent_alarm_events, POLICY-monitoring_rule_generation-search_manual |
