...
- Output tag: guardrail_10_nvidia_norm
...
| TC-017 | - | - | PASS | no | llm | - |
| TC-018 | - | - | PASS | yes | llm | - |
| TC-ACTION-008 | get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | search_manual, get_recent_alarm_events, get_quality_metrics, get_maintenance_history, get_process_status | PASS | yes | llm | - |
