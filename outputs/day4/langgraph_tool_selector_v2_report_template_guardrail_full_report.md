...
- Output tag: report_template_guardrail_full
...
| TC-017 | - | - | PASS | no | llm | - |
| TC-018 | - | - | PASS | no | llm | - |
| TC-ACTION-008 | get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | search_manual | NEEDS_REVIEW | yes | fallback | missing_tool |
