...
- Output tag: action_holdout_5_none
...
|---|---|---|---|---|---|---|
| HOLDOUT-ACTION-001 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_recent_alarm_events, search_manual, get_maintenance_history, get_quality_metrics, get_process_status | NEEDS_REVIEW | yes | fallback | missing_argument, missing_tool |
| HOLDOUT-ACTION-002 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | get_process_status, search_manual | NEEDS_REVIEW | yes | fallback | missing_tool |
| HOLDOUT-ACTION-003 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_recent_alarm_events, search_manual, get_maintenance_history, get_quality_metrics, get_equipment_status | NEEDS_REVIEW | yes | fallback | missing_tool |
| HOLDOUT-ACTION-004 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | search_manual, get_process_status | NEEDS_REVIEW | yes | fallback | missing_tool |
| HOLDOUT-ACTION-005 | get_equipment_status, get_recent_alarm_events, get_process_status, get_maintenance_history, search_manual | get_recent_alarm_events, search_manual, get_maintenance_history, get_process_status | NEEDS_REVIEW | yes | fallback | missing_argument, missing_tool |

## 3. Representative Failures

### Missing Tool

- HOLDOUT-ACTION-001: 기대 Tool 'get_equipment_status'이(가) plan에 없습니다.
- HOLDOUT-ACTION-002: 기대 Tool 'get_quality_metrics'이(가) plan에 없습니다.
- HOLDOUT-ACTION-003: 기대 Tool 'get_process_status'이(가) plan에 없습니다.
- HOLDOUT-ACTION-004: 기대 Tool 'get_quality_metrics'이(가) plan에 없습니다.
- HOLDOUT-ACTION-005: 기대 Tool 'get_equipment_status'이(가) plan에 없습니다.
...
- HOLDOUT-ACTION-001: step 5: 'get_process_status'은 process_name, line_id 중 하나 이상이 필요합니다.
- HOLDOUT-ACTION-005: step 4: 'get_process_status'은 process_name, line_id 중 하나 이상이 필요합니다.
