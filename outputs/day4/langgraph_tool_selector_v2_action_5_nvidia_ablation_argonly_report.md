...
- Output tag: action_5_nvidia_ablation_argonly
- Normalization mode: argument-only
- Normalization: Tool Contract argument normalization only. Action Tool Policy is disabled.
...
- Repair success: 2
- Needs review: 3
- Normalization applied: 4/5
- Action policy rules: 0
- Argument normalization rules: 6
...
|---|---|---|---|---|---|---|
| TC-ACTION-001 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_recent_alarm_events, get_equipment_status, get_maintenance_history, get_process_status, get_quality_metrics, search_manual | PASS | yes | llm | - |
| TC-ACTION-002 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | get_quality_metrics, get_process_status | NEEDS_REVIEW | yes | fallback | missing_tool |
| TC-ACTION-003 | get_equipment_status, get_recent_alarm_events, get_process_status, get_quality_metrics, get_maintenance_history, search_manual | get_equipment_status, get_recent_alarm_events, search_manual, get_maintenance_history, get_quality_metrics | NEEDS_REVIEW | yes | fallback | missing_tool, weak_reason |
| TC-ACTION-004 | get_recent_alarm_events, get_process_status, get_quality_metrics, search_manual | get_recent_alarm_events, get_process_status | NEEDS_REVIEW | yes | fallback | missing_tool |
| TC-ACTION-007 | get_equipment_status, get_recent_alarm_events, get_process_status, get_maintenance_history, search_manual | get_equipment_status, get_recent_alarm_events, get_maintenance_history, get_process_status, search_manual | PASS | yes | llm | - |
...
- TC-ACTION-003: 기대 Tool 'get_process_status'이(가) plan에 없습니다.
...
|---|---|---|
| TC-ACTION-001 | False | - |
| TC-ACTION-002 | True | ARG-get_process_status-anyof-process_name, ARG-get_quality_metrics-anyof-equipment_id |
| TC-ACTION-003 | True | ARG-get_process_status-anyof-process_name |
| TC-ACTION-004 | True | ARG-get_process_status-anyof-process_name, ARG-get_recent_alarm_events-equipment_id |
| TC-ACTION-007 | True | ARG-get_process_status-anyof-process_name |
